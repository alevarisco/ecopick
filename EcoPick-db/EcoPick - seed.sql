INSERT INTO `ecopick`.`preguntaseguridad`(`id`,`pregunta`) VALUES
('1', '¿Cuál es tu color favorito?'),
('2', '¿Cuál es la marca de tu primer auto?'),
('3', '¿Cuál es el nombre de tu abuela?'),
('4', '¿Cuál es la profesión de tu padre?'),
('5', '¿Cuál es la nacionalidad de tu abuelo?');
