...
public class DaoAnalisis extends Dao<AnalisisEntity> {
    ...
    public List<PreguntaEstudioDto> getOpenTextAnswers(long studyId)  {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("ecopick");
        EntityManager em = emf.createEntityManager();
        DaoEstudio daoEstudio = new DaoEstudio();
    ...
    public List<PreguntaEstudioDto> getSelectionAnswers(long studyId)  {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("ecopick");
        EntityManager em = emf.createEntityManager();
        DaoEstudio daoEstudio = new DaoEstudio();
        DaoTipoPregunta daoTipoPregunta = new DaoTipoPregunta();
    ...
    public List<PreguntaEstudioDto> getTrueFalseAnswers(long studyId)  {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("ecopick");
        EntityManager em = emf.createEntityManager();
        DaoEstudio daoEstudio = new DaoEstudio();
        DaoTipoPregunta daoTipoPregunta = new DaoTipoPregunta();
    ...
    public List<PreguntaEstudioDto> getRangeAnswers(long studyId)  {
        Object [] tuple = null;
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("ecopick");
        EntityManager em = emf.createEntityManager();
        DaoEstudio daoEstudio = new DaoEstudio();
